<?php 
/* Template Name: Story Single Template */ 
get_header(); ?>
        ...
        <div class="header-content">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo home_url('/stories'); ?>">Stories</a></li>
              <li class="breadcrumb-item active" aria-current="page">Chloe &amp; Catherine</li>
            </ol>
          </nav>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-12 py-5">
        <div class="service-text-content">
          <h1 class="mb-0">Chloe &amp; Catherine</h1>
