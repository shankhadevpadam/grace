    ...
    <div class="row">
      <div class="col-lg-12 py-5">
        <div class="service-text-content">
          ...
          <p>Regardless of location or type of support required, whether it’s house chores, community engagement, or high needs support, we can appropriately match one of our Support Stars to your needs.</p>
          <p>We not only deliver premium care, we also want you to enjoy the process, and company, of having a Support Star assist you in remaining independent, active in your community, and living in your own home.</p>
          <p>Our personalised support services are available to people of all ages and abilities including the elderly, respite for family members, or those returning home from hospital.</p>
          ...
          <p>In accordance with the requirements of the Workplace Gender Equality Act 2012 (Act), Health Solutions Group Australia has lodged its annual public report with the Workplace Gender Equality Agency (WGEA).</p>
          <a href="#" class="btn btn-primary text-white mt-3">Find out more</a>
        </div>
      </div>
    </div>
  </div>
